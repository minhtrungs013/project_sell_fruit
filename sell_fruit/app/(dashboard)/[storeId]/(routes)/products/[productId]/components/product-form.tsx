        ...
        <>
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 w-full">
                        ...
                        <FormItem>
                            ...
                            <FormControl>
                                <ImageUpload
                                    ...
                                    onRemove={(url) => field.onChange([...field.value.filter((currnet) => currnet.url !== url)])}
                                />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    ...
                    <div className="grid grid-cols-3 gap-8">
                        ...
                        <FormField control={form.control} name="price" render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input disabled={loading} type="number" placeholder="0.00" {...field} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )} />
                    ...
                    <Button className="ml-auto mr-4" type="button" variant={"outline"} onClick={() => router.push(`/${params.storeId}/products`)}>Cancel</Button>
